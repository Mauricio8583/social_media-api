...
export const register = (req, res) => {
    ...
    db.query(verificationQuery, [req.body.username], (err, data) => {
        ...
        const insertQuery = "INSERT INTO users (`id`,`username`, `email`, `pass`, `nome`) VALUES (?)";

        const reqValues = [id,req.body.username, req.body.email, hashedPassword, req.body.name]
